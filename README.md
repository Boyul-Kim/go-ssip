...
- [x] Add a consumer that drains the dead-letter queue; treat the DLQ as the poison-message destination for messages that fail repeatedly.
...
- [ ] Add graceful shutdown and propagate `context` into `Publish`.